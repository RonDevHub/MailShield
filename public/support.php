    ...
    <div class="max-w-lg w-full">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 text-center">
            ...
            <div class="grid gap-4">
                <a href="https://paypal.me/DEIN_NAME" target="_blank" class="flex items-center justify-between p-4 bg-blue-600/10 hover:bg-blue-600 hover:text-white border border-blue-600/20 rounded-2xl transition-all group">
                ...
                <a href="https://ko-fi.com/DEIN_NAME" target="_blank" class="flex items-center justify-between p-4 bg-orange-600/10 hover:bg-orange-600 hover:text-white border border-orange-600/20 rounded-2xl transition-all group">
                ...
                <div x-data="{ copied: false }" class="p-4 bg-gray-100 dark:bg-gray-700/50 rounded-2xl border border-gray-200 dark:border-gray-600">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <button @click="navigator.clipboard.writeText('DEINE_BTC_ADRESSE'); copied = true; setTimeout(() => copied = false, 2000)" class="text-xs text-blue-500 hover:underline">
