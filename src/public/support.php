    ...
    <div class="max-w-lg w-full">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 text-center">
            ...
            <div class="grid gap-4">
                ...
                <a href="https://github.com/sponsors/RonDevHub" target="_blank" class="flex items-center justify-between p-4 bg-yellow-600/10 hover:bg-yellow-600 hover:text-white border border-yellow-600/20 rounded-2xl transition-all group">
